...
describe("Home Page", () => {
  ...
  it("renders correctly", () => {
    ...
    fireChangeForInputTimeIfValid(getByPlaceholderText('Select a date and time'), new Date(), "08/02/2023");
  ...
  it("should submit request with valid form attributes", () => {
    ...
    fireEvent.click(getByText("Planning an upcoming travel, create your travel request here"));
    fireEvent.change(getByPlaceholderText("Project Code"), { target: { value: "abc" } });
    fireEvent.change(getByPlaceholderText("Pickup Location"), { target: { value: "Address" } });
    fireEvent.change(getByPlaceholderText("Drop Location"), { target: { value: "Location" } });
    fireChangeForInputTimeIfValid(getByPlaceholderText('Select a date and time'), new Date(), "08/02/2023");
